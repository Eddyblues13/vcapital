                ...
                <table border='0' align='center' width='590' cellpadding='0' cellspacing='0' class='container590'>
                    <tr>
                        <td align="left"
                            ...
                            <p>Dear {{ $tradeDetails['user_name'] }},</p>
                            <p>Your trade has been successfully started with the following details:</p>
                            <ul>
                                <li>Amount: ${{ $tradeDetails['amount'] }}</li>
                                <li>Trader: {{ $tradeDetails['trader_name'] }}</li>
                                <li>ROI: {{ $tradeDetails['roi'] }}%</li>
                                <li>Duration: {{ $tradeDetails['trade_duration'] }}</li>
                            </ul>
